...
from ui.rsa import Ui_MainWindow # Giả sử file UI được tạo từ Qt Designer là ui/rsa.py
import requests
...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        # Kết nối tín hiệu từ nút bấm tới các hàm xử lý
    ...
    def call_api_gen_keys(self):
        ...
        try:
            ...
            print(f"Error: {str(e)}")
            QMessageBox.critical(self, "Connection Error", f"Could not connect to API: {str(e)}")
